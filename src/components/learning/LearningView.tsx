    ...
    return (
            ...
            <header className="h-16 flex items-center justify-between px-4 lg:px-6 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 shrink-0 sticky top-0 z-30 transition-colors duration-300">
                ...
                <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    <button
                        ...
                        className={`p-2 rounded-lg transition-colors ${showChat ? 'bg-cyan-100 dark:bg-cyan-900/30 text-cyan-600 dark:text-cyan-400' : 'text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800'}`}
                        title={showChat ? '收起 AI 助教' : '展开 AI 助教'}
                    >
        ...
        `}>
                            ...
                            <div className="space-y-1 relative mt-4">
                                ...
                                {course.lessons.map((lesson, idx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className={`mt-0.5 shrink-0 transition-colors duration-300 ${isActive ? 'text-cyan-600 dark:text-cyan-400' :
                ...
                <div className="flex-1 relative flex flex-col min-w-0 overflow-hidden">
                        ...
                        <div className="max-w-4xl mx-auto px-6 py-12 md:py-16">
                            ...
                            <div className="mt-16 pt-8 border-t border-slate-200 dark:border-slate-800 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <button
                                    ...
                                    className={`group p-6 text-left rounded-2xl border transition-all duration-300 ${activeLessonIndex === 0
                    ...
                    <button
                        onClick={scrollToTop}
                        className={`absolute bottom-6 right-6 z-20 p-3 rounded-full bg-cyan-600/90 hover:bg-cyan-500 text-white shadow-lg backdrop-blur-sm transition-all duration-300 transform border border-cyan-400/20 ${showScrollTop ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0 pointer-events-none'
                            }`}
                        title="回到顶部"
                    >
                        <ArrowUp size={20} />
