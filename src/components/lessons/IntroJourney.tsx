  ...
  <div className={`relative overflow-hidden rounded-3xl bg-slate-900 text-white shadow-2xl isolate flex flex-col justify-center ${isPresentation ? 'h-full w-full max-w-6xl mx-auto' : 'min-h-[380px]'}`}>
    ...
    <div className="relative z-10 p-6 md:p-8 flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-cyan-300 text-sm font-bold uppercase tracking-wider backdrop-blur-md">
                <Brain size={16} />
            ...
            <div className="flex flex-col gap-4 mt-4">
                ...
                {!isPresentation && (
                    <button 
                        onClick={onNext}
                        className="inline-flex items-center gap-2 px-6 py-3 bg-white text-indigo-900 hover:bg-cyan-50 rounded-xl font-bold transition-all hover:scale-105 shadow-lg shadow-black/20 self-start text-lg"
                    >
                        开始探索
                        <ArrowRight size={20} />
                    </button>
        ...
        <div className="flex-1 w-full max-w-xs relative hidden md:block">
             <div className="relative aspect-square">
                 ...
                 <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-white/5 border border-white/30 rounded-2xl shadow-xl z-30 flex flex-col items-center justify-center p-6 text-center backdrop-blur-xl">
                    ...
                    <div className="font-bold text-2xl">Thinking in AI</div>
                    <div className="text-white/70 text-base mt-2">Data + Goal = Rules</div>
                 </div>
             </div>
        </div>
    </div>
...
const WhyAI_Part1 = () => (
    <>
        <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-4xl font-bold text-slate-900 dark:text-white">0.1 我们为什么学 AI？</h2>
        </div>
        ...
        <div className="space-y-6 mb-8">
             <div className="p-4 bg-blue-50 dark:bg-blue-900/10 border-l-4 border-blue-500 rounded-r-xl">
                 <div className="flex items-center gap-2 font-bold text-blue-700 dark:text-blue-300 mb-2">
                     <Lightbulb size={20} />
                     <span className="text-lg">Paradigm Shift (范式转移)</span>
                 </div>
             ...
             <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl shadow-sm">
                    <h4 className="font-bold text-slate-800 dark:text-slate-200 mb-2 flex items-center gap-2 text-lg">
                        <Database size={20} className="text-purple-500"/> 解锁非结构化数据
                    </h4>
                ...
                <div className="p-4 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl shadow-sm">
                    <h4 className="font-bold text-slate-800 dark:text-slate-200 mb-2 flex items-center gap-2 text-lg">
                        <Shield size={20} className="text-green-500"/> 职业护城河
                    </h4>
                    <p className="text-base text-slate-600 dark:text-slate-400 leading-relaxed">
    ...
    <div className="grid md:grid-cols-2 gap-8 w-full">
      <div className="group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 transition-all hover:shadow-xl relative overflow-hidden">
        <div className="relative z-10">
            <div className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-2">The Old Way</div>
            <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">Software 1.0</h3>
            
            <p className="text-base text-slate-500 dark:text-slate-400 mb-4">
                程序员显式地编写规则（If-Else）。比如写一个垃圾邮件过滤器，你需要列出所有可能的敏感词。这很难穷尽。
            </p>

            <div className="p-3 bg-slate-50 dark:bg-black/50 rounded-xl border border-slate-100 dark:border-slate-800 font-mono text-sm text-slate-600 dark:text-slate-400">
      ...
      <div className="group bg-white dark:bg-slate-900 border border-cyan-200 dark:border-cyan-900/50 rounded-3xl p-6 transition-all hover:shadow-xl relative overflow-hidden ring-1 ring-cyan-100 dark:ring-cyan-900/30">
        <div className="relative z-10">
            <div className="text-sm font-bold text-cyan-600 dark:text-cyan-400 uppercase tracking-wider mb-2">The New Way</div>
            <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">Software 2.0</h3>
            
            <p className="text-base text-slate-500 dark:text-slate-400 mb-4">
                程序员不再编写规则，而是<strong>定义目标</strong>并提供<strong>数据</strong>。你只需要给模型看 1 万封垃圾邮件，它就能自己学会分辨。
            </p>

            <div className="p-3 bg-cyan-50/50 dark:bg-cyan-900/10 rounded-xl border border-cyan-100 dark:border-cyan-900/30 font-mono text-sm text-slate-600 dark:text-slate-400">
...
const Skills_Part1 = () => (
    <>
        <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-4xl font-bold text-slate-900 dark:text-white">0.2 必备技能锦囊</h2>
        </div>
        ...
        <div className="mb-8">
            ...
            <div className="p-4 bg-amber-50 dark:bg-amber-900/10 border-l-4 border-amber-500 rounded-r-xl">
                 <div className="flex items-center gap-2 font-bold text-amber-700 dark:text-amber-300 mb-2">
                     ...
                     <span className="text-lg">学习建议</span>
                 </div>
                 <p className="text-slate-600 dark:text-slate-300 text-base leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm">
            <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-4 flex items-center gap-2">
                <BookOpen size={24} className="text-blue-500"/> 装备包 A：数学基础 (理论核心)
            </h3>
            <div className="grid md:grid-cols-3 gap-6 text-base">
                <div>
                    <h4 className="font-bold text-slate-900 dark:text-white mb-1 text-lg">线性代数</h4>
                    <p className="text-slate-500 dark:text-slate-400 text-sm mb-2">数据容器：向量、矩阵、维度变换</p>
                    <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">计算机眼中的图片不是图，而是一个巨大的数字矩阵。</p>
                </div>
                <div>
                    <h4 className="font-bold text-slate-900 dark:text-white mb-1 text-lg">微积分</h4>
                    <p className="text-slate-500 dark:text-slate-400 text-sm mb-2">优化引擎：导数、梯度</p>
                    <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">训练模型的过程就像“下山”，梯度告诉我们往哪个方向走。</p>
                </div>
                <div>
                    <h4 className="font-bold text-slate-900 dark:text-white mb-1 text-lg">概率统计</h4>
                    <p className="text-slate-500 dark:text-slate-400 text-sm mb-2">不确定性：分布、期望</p>
                    <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">现实世界是充满噪声的，模型输出的永远是一个概率。</p>
                </div>
            </div>
        </div>
    </>
...
const Skills_Part2 = () => (
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm w-full">
        <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-4 flex items-center gap-2">
            <Zap size={24} className="text-yellow-500"/> 装备包 B：编程基础 (工程核心)
        </h3>
        <ul className="text-base text-slate-500 dark:text-slate-400 space-y-4">
            <li className="flex flex-col gap-1 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
                <div className="flex gap-2 font-bold text-slate-700 dark:text-slate-300 text-lg">
                    <span>Python:</span>
                    <span className="font-normal text-slate-500">AI 领域的通用语</span>
                </div>
                <p className="text-sm text-slate-500">需熟练掌握列表推导式、类 (Class) 与对象、装饰器等中级特性。</p>
            </li>
            <li className="flex flex-col gap-1 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
                <div className="flex gap-2 font-bold text-slate-700 dark:text-slate-300 text-lg">
                ...
                <p className="text-sm text-slate-500">NumPy 处理多维数组；Pandas 清洗数据；Matplotlib 绘制图表。</p>
            </li>
            <li className="flex flex-col gap-1 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
                <div className="flex gap-2 font-bold text-slate-700 dark:text-slate-300 text-lg">
                ...
                <p className="text-sm text-slate-500">提供现成的算法实现（如决策树、SVM），是理解机器学习流程的最佳起点。</p>
            </li>
            <li className="flex flex-col gap-1 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
                <div className="flex gap-2 font-bold text-slate-700 dark:text-slate-300 text-lg">
                    <span>PyTorch:</span>
                ...
                <p className="text-sm text-slate-500">目前学术界和工业界最流行的深度学习框架，如同乐高积木一样灵活。</p>
            </li>
        </ul>
    </div>
);
...
const Valley_Part1 = () => (
    <>
        <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-4xl font-bold text-slate-900 dark:text-white">0.3 达克效应学习曲线</h2>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-4 md:p-8 border border-slate-200 dark:border-slate-800 shadow-sm mb-4 flex-1 min-h-[300px] md:min-h-[350px] flex items-center justify-center">
           <div className="aspect-[2/1] w-full relative h-full">
               <svg viewBox="0 0 800 350" className="w-full h-full overflow-visible">
                  ...
                  <text x="750" y="320" className="fill-slate-500 text-sm font-bold">能力</text>
                  <text x="20" y="20" className="fill-slate-500 text-sm font-bold" writingMode="tb">自信</text>
                  ...
                  <path 
                   ...
                   <g className="group cursor-pointer">
                      ...
                      <text x="150" y="-10" textAnchor="middle" className="fill-slate-700 dark:fill-slate-200 text-sm font-bold">蜜月期</text>
                   </g>

                   <g className="group cursor-pointer">
                      <circle cx="350" cy="280" r="8" className="fill-white stroke-red-500 stroke-4" />
                      <text x="350" y="310" textAnchor="middle" className="fill-slate-700 dark:fill-slate-200 text-sm font-bold">绝望之谷</text>
                   </g>

                   <g className="group cursor-pointer">
                      <circle cx="750" cy="80" r="8" className="fill-white stroke-green-500 stroke-4" />
                      <text x="750" y="50" textAnchor="middle" className="fill-slate-700 dark:fill-slate-200 text-sm font-bold">精通高原</text>
                   </g>
               </svg>
           </div>
        </div>
    ...
    <div className="grid md:grid-cols-2 gap-6 w-full">
         <div className="space-y-4">
            <div className="p-4 bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-xl hover:shadow-md transition-shadow">
                <h4 className="font-bold text-pink-500 text-base mb-2">第一阶段：蜜月期 (愚昧之山)</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                    你跟着教程跑通了 Hello World 级别的 Demo（如手写数字识别），代码一运行，准确率 99%。心态：“AI 也不过如此嘛，简单！”
                </p>
            </div>
            <div className="p-4 bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-xl hover:shadow-md transition-shadow">
                <h4 className="font-bold text-red-500 text-base mb-2 flex items-center gap-2">
                    <AlertTriangle size={16}/> 第二阶段：绝望之谷 (高危流失区)
                </h4>
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-2">
                    当你试图处理自己的数据时，报错开始了：<code className={inlineCodeClass}>RuntimeError: size mismatch</code>。Loss 居高不下。
                </p>
         ...
         <div className="space-y-4">
            <div className="p-4 bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-xl hover:shadow-md transition-shadow">
                <h4 className="font-bold text-amber-500 text-base mb-2">第三阶段：开悟之坡</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                    你开始理解为什么 Learning Rate 设大了会震荡，为什么这里需要加一层 Normalization。你能看懂 PyTorch 的官方文档了。
                </p>
            </div>
            <div className="p-4 bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 rounded-xl hover:shadow-md transition-shadow">
                <h4 className="font-bold text-green-500 text-base mb-2">第四阶段：精通高原</h4>
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
...
export const IntroFooter: React.FC<SectionProps> = ({ onNext, isPresentation }) => (
  <div className={`w-full flex flex-col items-center justify-center text-center p-8 ${isPresentation ? 'h-full' : ''}`}>
     <p className="italic text-slate-400 font-serif text-3xl mb-12">
       "The best way to predict the future is to invent it."
     </p>
     {!isPresentation && (
         <button 
            onClick={onNext}
            className="inline-flex items-center gap-3 px-8 py-4 bg-cyan-600 hover:bg-cyan-500 text-white rounded-full font-bold text-xl transition-all hover:scale-105 shadow-xl shadow-cyan-600/30 ring-4 ring-cyan-600/20"
         >
            <CheckCircle size={28} />
            我已经准备好了
         </button>
